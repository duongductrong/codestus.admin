...
import { useCurrentEditorContext } from "../_components/use-editor-context"
...
export interface ToolbarEditorVariantsProps extends VariantProps<typeof toolbarEditorVariants> {}

export interface ToolbarEditorProps
  extends ComponentPropsWithoutRef<"div">,
    ToolbarEditorVariantsProps {
  root?: {
    width: number
    height: number
  }
...
const ToolbarEditor = ({ className, direction, root, ...props }: ToolbarEditorProps) => {
