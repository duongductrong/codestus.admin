...
import EditorAction from "./_components/editor-action"
  ...
  <TooltipProvider>
    <aside className="fixed inset-y-0 left-0 top-[calc(var(--el-header-height)+var(--el-toolbar-height))] z-10 hidden w-14 flex-col border-r bg-background sm:flex">
      <nav className="flex flex-col items-center gap-4 px-2 py-4">
        <EditorAction icon={<Pen />} title="Pen" />
        <EditorAction icon={<Paperclip />} title="Paper" />
        <EditorAction icon={<PaintBucket />} title="Color" />
      </nav>
